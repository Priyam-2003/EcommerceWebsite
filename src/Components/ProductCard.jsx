  ...
  return (
    <div className="group border border-gray-100 rounded-xl bg-white overflow-hidden cursor-pointer hover:shadow-xl transition-all">
      ...
      <div className="p-2 flex flex-col gap-2">
        ...
        <button className="bg-red-500 hover:bg-red-600 transition-colors text-white py-2 rounded-md flex items-center justify-center gap-2 font-semibold" onClick={()=>addToCart(item,1)}>
